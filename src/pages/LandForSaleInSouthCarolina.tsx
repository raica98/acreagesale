...
export function LandForSaleInSouthCarolina() {
  ...
  const stats = [
    { icon: Building, label: "Active Listings", value: "2,200+", color: "text-blue-600" },
    { icon: DollarSign, label: "Avg. Price/Acre", value: "$12,500", color: "text-green-600" },
    { icon: MapPin, label: "Total Acres", value: "65,000+", color: "text-purple-600" },
    { icon: TrendingUp, label: "Price Growth", value: "+14%", color: "text-orange-600" }
  ];

  const features = [
    { icon: Factory, title: "Manufacturing and industrial growth", description: "Strong job market" },
    { icon: Waves, title: "Coastal access and tourism", description: "Premium development opportunities" },
    { icon: Building, title: "Business-friendly regulations", description: "Streamlined development process" },
    { icon: Sun, title: "Mild climate year-round", description: "Extended construction seasons" },
    { icon: GraduationCap, title: "Quality educational institutions", description: "Attracts families and businesses" },
    { icon: Target, title: "Strategic Southeast location", description: "Access to major markets" }
  ];

  const utilities = [
    { icon: Zap, title: "Electricity", provider: "Duke Energy/Santee Cooper", cost: "$2,000-$10,000" },
    { icon: Droplets, title: "Water", provider: "Municipal/Well Systems", cost: "$5,000-$12,000" },
  ...
  const submarkets = [
    {
      title: "Coastal South Carolina",
      description: "Premium coastal properties with tourism and resort development potential. Higher land values but exceptional appreciation prospects.",
      priceRange: "$25,000-$75,000 per acre",
      features: ["Beachfront and near-beach development sites", "Resort and hospitality development opportunities", "Luxury residential communities"]
    },
    {
      title: "Upstate South Carolina", 
      description: "Manufacturing and industrial corridor with strong infrastructure and workforce availability. Balanced pricing with solid fundamentals.",
      priceRange: "$8,000-$20,000 per acre",
      features: ["Industrial and manufacturing sites", "Suburban residential development", "Mixed-use commercial opportunities"]
    },
    {
      title: "Midlands South Carolina",
      description: "Government and university hub with stable employment and consistent demand. Excellent for long-term investment strategies.",
      priceRange: "$12,000-$30,000 per acre", 
      features: ["Government and institutional development", "University-adjacent properties", "Professional office and medical facilities"]
    },
    {
      title: "Rural South Carolina",
      description: "Agricultural and recreational land with lower entry costs and diverse use potential. Perfect for patient capital and alternative investments.",
      priceRange: "$3,000-$8,000 per acre",
      features: ["Agricultural and farming operations", "Recreational and hunting properties", "Timber and forestry investments"]
    }
  ];
  ...
  const featuredProperties = [
    {
      id: "sc-1",
      title: "20-Acre Development Site",
    ...
    },
    {
      ...
      location: "Downtown South Carolina",
      acres: 3.2,
      price: 950000,
    ...
    },
    {
      ...
      location: "South Carolina Suburbs", 
      acres: 8.5,
      price: 675000,
  ...
  const zoningTypes = [
    { code: "R-1", title: "Single Family", description: "Low-density residential, minimum 1-acre lots" },
    { code: "R-2", title: "Medium Density", description: "Medium-density residential, townhomes allowed" },
  ...
  if (success) {
    <SEO slug="land-for-sale-in-south-carolina" />
    return (
        ...
        <Card className="w-full max-w-2xl mx-4 shadow-2xl border-0 rounded-3xl overflow-hidden">
          <CardContent className="p-12 text-center">
            ...
            <p className="text-xl text-gray-600 mb-8 leading-relaxed">
              We've received your information and will send you the complete list of land for sale in South Carolina.
            </p>
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold text-gray-900 mb-8 leading-tight">
              Land for Sale in <span className="text-[#329cf9]">South Carolina</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center mb-16">
              <Link to="/properties?search=South Carolina">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
              Why South Carolina is a <span className="text-[#329cf9]">Prime Investment Market</span>
            </h2>
      ...
      <section className="py-20 bg-gradient-to-br from-gray-50 to-blue-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
              Featured South Carolina <span className="text-[#329cf9]">Properties</span>
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
          ...
          <div className="text-center">
            <Link to="/properties?search=South Carolina">
              <Button className="bg-[#329cf9] hover:bg-[#2563eb] text-white px-8 py-4 text-lg font-semibold rounded-xl">
                View All South Carolina Properties
              </Button>
            </Link>
          </div>
        </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
              South Carolina Regional <span className="text-[#329cf9]">Submarkets</span>
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
      ...
      <section className="py-20 bg-gradient-to-br from-gray-50 to-blue-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
              Want to Buy Land in <span className="text-[#329cf9]">South Carolina?</span>
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Fill up the form to get a full list of Land for sale in South Carolina.
            </p>
          </div>
                    ...
                    <div className="md:col-span-2">
                      ...
                      <div className="relative">
                        ...
                        <Input
                          ...
                          placeholder="Preferred Location in South Carolina"
                          className="pl-12 h-14 border-2 border-gray-200 rounded-xl focus:border-[#329cf9] text-lg"
                        />
                      </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="prose prose-lg max-w-none">
            <h2 className="text-3xl font-bold text-gray-900 mb-8">Land for Sale in South Carolina</h2>
            ...
            <h3 className="text-2xl font-bold text-gray-900 mb-6">How to Find the Best Land for Sale in South Carolina</h3>
            ...
            <h3 className="text-2xl font-bold text-gray-900 mb-6">Tips to Find Cheap Land for Sale in South Carolina</h3>
      ...
      <section className="py-20 bg-[#329cf9]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-4xl md:text-5xl font-bold mb-8 text-white">
            Ready to Invest in South Carolina Land?
          </h2>
