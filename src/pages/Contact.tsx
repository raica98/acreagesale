...
import { z } from 'zod';
import { ArrowLeft, Phone, Mail, MessageCircle, Calendar, Clock, MapPin, User, Send, Star, CircleCheck as CheckCircle, Building, Globe, Users, TrendingUp, Award, Shield, Zap, Eye, FileText } from 'lucide-react';
...
export function Contact() {
  ...
  const handleSubmit = async (data: ContactForm) => {
    ...
    try {
      ...
      const existingSubmissions = JSON.parse(localStorage.getItem('contact_inquiries') || '[]');
      existingSubmissions.unshift(submissionData);
      localStorage.setItem('contact_inquiries', JSON.stringify(existingSubmissions));
  ...
  const offices = [
    {
      ...
      address: "4470 W Sunset Blvd, Suite #91147",
      fullAddress: "Los Angeles, CA 90027",
  ...
  const faqs = [
    {
      ...
      answer: "We typically respond to all inquiries within 2 hours during business hours. For urgent matters, please call us directly at 949-767-8885."
    },
    {
      question: "What are your business hours?",
      answer: "Our main office hours are Monday-Friday 9AM-6PM PST. However, our phone line is available 24/7 for urgent land buying and selling inquiries."
    },
    {
      question: "Do you have physical offices I can visit?",
      answer: "Our headquarters is in Los Angeles, CA. We also have virtual offices in major markets across the US. Most of our business is conducted remotely for your convenience."
    },
    {
      question: "Can I schedule a consultation?",
      answer: "Yes! We offer free consultations for both buyers and sellers. You can schedule a call through our website or by calling us directly."
    },
    {
      question: "What information should I include in my message?",
      answer: "Please include as much detail as possible about your inquiry - property location, size, timeline, and any specific questions you have. This helps us provide more accurate assistance."
    },
    {
      question: "Do you provide support for technical issues?",
      answer: "Yes, we have a dedicated technical support team to help with website issues, account problems, and platform questions."
    }
  ];
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50">
              ...
              <Card className="p-8 border-0 shadow-xl bg-gradient-to-br from-blue-50 to-indigo-50">
                <CardContent className="p-0">
                  <div className="text-center mb-6">
                    ...
                    <h3 className="text-2xl font-bold text-gray-900 mb-2">Office Locations</h3>
                    <p className="text-blue-700 font-medium">Serving all 50 states</p>
                  </div>
                  
                  <div className="space-y-6">
                    {offices.map((office, index) => (
                      <div key={index} className={`p-4 rounded-xl border ${office.isHeadquarters ? 'bg-blue-50 border-blue-200' : 'bg-gray-50 border-gray-200'}`}>
                        <div className="flex items-start gap-3">
                          <MapPin className="w-5 h-5 text-[#329cf9] mt-1" />
                          <div>
                            <h4 className="font-bold text-gray-900">{office.city}</h4>
                            <p className="text-gray-600 text-sm">{office.address}</p>
                            <p className="text-gray-600 text-sm">{office.fullAddress}</p>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
              Our <span className="text-[#329cf9]">Locations</span>
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Headquartered in Los Angeles with virtual offices nationwide
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {offices.map((office, index) => (
              <Card key={index} className={`p-8 border-0 shadow-lg hover:shadow-xl transition-all duration-300 ${office.isHeadquarters ? 'ring-2 ring-[#329cf9] bg-blue-50' : 'bg-white'}`}>
                <CardContent className="p-0">
                  <div className="text-center">
                    <div className={`w-16 h-16 ${office.isHeadquarters ? 'bg-[#329cf9]' : 'bg-gray-600'} rounded-2xl flex items-center justify-center mx-auto mb-6`}>
                    ...
                    {office.isHeadquarters && (
                      <Badge className="bg-[#329cf9] text-white mt-4">
                        Headquarters
                      </Badge>
                    )}
                  </div>
