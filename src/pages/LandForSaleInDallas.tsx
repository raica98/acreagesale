...
import { z } from 'zod';
import { ArrowLeft, Phone, Mail, MapPin, DollarSign, Ruler, TrendingUp, Users, Building, Star, Award, Eye, CircleCheck as CheckCircle, Target, ChartBar as BarChart3, Globe, Shield, Zap, User, Send, Clock, TreePine, Chrome as Home, Factory, Briefcase, GraduationCap, Heart, ShoppingBag, Car, Plane } from 'lucide-react';
...
export function LandForSaleInDallas() {
  const { user } = useAuth();
  ...
  const marketStats = [
    { label: "Metro Population", value: "7.8M", color: "text-blue-600" },
  ...
  const marketFactors = [
    {
      ...
      description: "Dallas-Fort Worth metroplex continues to attract new residents, driving demand for both residential and commercial land development opportunities.",
      icon: Users
    },
    {
      title: "Economic Diversification", 
      description: "Strong economy across technology, finance, healthcare, and energy sectors creates stable demand for various types of land development projects.",
      icon: BarChart3
    },
    {
      title: "Strategic Location",
      description: "Central location in Texas with excellent transportation infrastructure makes Dallas land attractive for logistics, distribution, and manufacturing developments.",
      icon: MapPin
    }
  ];
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "When you work with Acreage Sale, you avoid the expense of paying a middleman, who typically charges 5% to 8% of the purchase price. We have all the resources you need to start planning your sale."
    }
  ];

  useEffect(() => {
    fetchDallasProperties();
  }, []);

  const fetchDallasProperties = async () => {
    try {
  ...
  const handleSubmit = async (data: ContactForm) => {
    ...
    try {
      ...
      const existingSubmissions = JSON.parse(localStorage.getItem('dallas_land_inquiries') || '[]');
      existingSubmissions.unshift(submissionData);
      localStorage.setItem('dallas_land_inquiries', JSON.stringify(existingSubmissions));
  ...
  if (success) {
    <SEO slug="land-for-sale-in-dallas" />
    return (
        ...
        <Card className="w-full max-w-2xl mx-4 shadow-2xl border-0 rounded-3xl overflow-hidden">
          <CardContent className="p-12 text-center">
            ...
            <p className="text-xl text-gray-600 mb-8 leading-relaxed">
              We've received your Dallas land inquiry and will send you a comprehensive list of available properties within 24 hours.
            </p>
            <div className="bg-blue-50 rounded-2xl p-6 mb-8">
              <h3 className="text-lg font-bold text-blue-900 mb-4">What You'll Receive:</h3>
              <div className="space-y-3 text-left">
                <div className="flex items-center gap-3">
                  <CheckCircle className="w-5 h-5 text-green-600" />
                  <span className="text-blue-800">Complete list of Dallas land for sale</span>
                </div>
                <div className="flex items-center gap-3">
                  <CheckCircle className="w-5 h-5 text-green-600" />
                  <span className="text-blue-800">Market analysis and pricing trends</span>
                </div>
                <div className="flex items-center gap-3">
                  <CheckCircle className="w-5 h-5 text-green-600" />
                  <span className="text-blue-800">Investment recommendations based on your criteria</span>
                </div>
              </div>
            </div>
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold text-gray-900 mb-8 leading-tight">
              Land for Sale in <span className="text-[#329cf9]">Dallas</span>
            </h1>
            <p className="text-xl md:text-2xl text-gray-600 max-w-4xl mx-auto leading-relaxed mb-12">
              Discover prime investment opportunities in one of America's most dynamic markets. From residential development to commercial ventures, Dallas offers exceptional potential.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
              Why Dallas is a <span className="text-[#329cf9]">Prime Investment Market</span>
            </h2>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-16">
            <div className="space-y-8">
              <div className="space-y-6">
                <p className="text-xl text-gray-700 leading-relaxed">
                  Population growth and diversified employment continue to drive demand for land across Dallas.
                </p>
                <p className="text-xl text-gray-700 leading-relaxed">
            ...
            <div className="relative">
              <img
                ...
                alt="Dallas vacant land development opportunities"
                className="w-full h-96 object-cover rounded-3xl shadow-2xl"
              />
              <div className="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent rounded-3xl"></div>
              <div className="absolute bottom-8 left-8 text-white">
                <h3 className="text-2xl font-bold mb-2">Dallas</h3>
      ...
      <section className="py-20 bg-gradient-to-br from-gray-50 to-blue-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
              Why Choose <span className="text-[#329cf9]">Acreage Sale</span> for Dallas Land?
            </h2>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
              Success Stories from <span className="text-[#329cf9]">Dallas Investors</span>
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
      ...
      {/* Complete Dallas Land Guide */}
      <section className="py-20 bg-gradient-to-br from-gray-50 to-blue-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
              Complete <span className="text-[#329cf9]">Dallas Land Guide</span>
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Everything you need to know about buying land in Dallas
            </p>
          </div>

          <div className="prose prose-lg max-w-none">
            <div className="bg-white rounded-3xl p-8 lg:p-12 shadow-2xl border border-gray-200">
              <h3 className="text-3xl font-bold text-gray-900 mb-8">Land for Sale in Dallas</h3>
              
              <p className="text-lg text-gray-700 leading-relaxed mb-6">
                Looking to buy land for sale in Dallas? There are plenty of options out there, ranging from homesites with utilities to raw acreage and everything in between. Before you jump on the first piece of land for sale that you see, however, it pays to do your homework first.
              </p>
              ...
              <h4 className="text-2xl font-bold text-gray-900 mb-6">How to Find the Best Land for Sale in Dallas</h4>
              ...
              <h4 className="text-2xl font-bold text-gray-900 mb-6">Tips to Find Cheap Land for Sale in Dallas</h4>
              ...
              <h5 className="text-xl font-bold text-gray-900 mb-4">3) Look for land development opportunities</h5>
              ...
              <h5 className="text-xl font-bold text-gray-900 mb-4">4) Finding Cheap Land for Sale Doesn't Mean Strictly Buying</h5>
              ...
              <h5 className="text-xl font-bold text-gray-900 mb-4">5) Take the time to find the right property for you</h5>
              ...
              <div className="bg-blue-50 rounded-2xl p-8 border border-blue-200 mb-8">
                <h4 className="text-2xl font-bold text-blue-900 mb-6">ABOUT ACREAGE SALE</h4>
                <p className="text-lg text-blue-800 leading-relaxed">
                  We at Acreage Sale striving to create the most cutting-edge and engaging property market by connecting all aspects of land ownership, from locating land for sale in Dallas to connecting landowners with prospective buyers. For professionals, we're striving to improve by collecting, analyzing, and improving in order to deliver the highest quality leads in the industry. Our firm believes that helping others is a responsibility, as well as being honest and open to learning. We work tirelessly to create more value for our customers and passionately advocate for responsible land ownership everywhere. When we make mistakes, we admit them, work hard to create more value for our clients, and advocate for responsible land ownership everywhere.
                </p>
                
                <div className="mt-8 text-center">
                  <h5 className="text-xl font-bold text-blue-900 mb-4">Fill up the form to get a full list of Land for sale in Dallas.</h5>
                  <div className="flex items-center justify-center gap-8">
                    <div className="text-center">
                      <div className="w-16 h-16 bg-blue-600 rounded-2xl flex items-center justify-center mx-auto mb-3">
                        <CheckCircle className="w-8 h-8 text-white" />
                      </div>
                      <div className="font-bold text-blue-900">100% Guarantee</div>
                    </div>
                    <div className="text-center">
                      <div className="w-16 h-16 bg-green-600 rounded-2xl flex items-center justify-center mx-auto mb-3">
                        <Target className="w-8 h-8 text-white" />
                      </div>
                      <div className="font-bold text-blue-900">Multiple Offers</div>
                    </div>
                    <div className="text-center">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              <div className="mb-8">
                <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
                  Want to Buy Land in <span className="text-[#329cf9]">Dallas?</span>
                </h2>
                <p className="text-xl text-gray-600 leading-relaxed">
                  Fill up the form to get a full list of Land for sale in Dallas.
                </p>
              </div>
                  ...
                  <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-6">
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        placeholder="Tell us about your specific requirements, preferred locations in Dallas, or any questions you have..."
                    ...
                    >
                      {formLoading ? (
                        <div className="flex items-center gap-3">
                          ...
                          Getting Your Dallas Land List...
                        </div>
                      ) : (
                        <div className="flex items-center gap-3">
                          <Send className="w-6 h-6" />
                          Get My Dallas Land List
                        </div>
                      )}
                    </Button>
              ...
              <Card className="p-8 border-0 shadow-xl bg-gradient-to-br from-green-50 to-emerald-50">
                <CardContent className="p-0">
                  <div className="text-center mb-6">
                    ...
                    <p className="text-green-700 font-medium">Quality properties verified</p>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card className="p-8 border-0 shadow-xl bg-gradient-to-br from-blue-50 to-indigo-50">
                <CardContent className="p-0">
                  <div className="text-center mb-6">
                    ...
                    <p className="text-blue-700 font-medium">Various investment options</p>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card className="p-8 border-0 shadow-xl bg-gradient-to-br from-purple-50 to-violet-50">
                <CardContent className="p-0">
                  <div className="text-center">
                    ...
                    <p className="text-purple-700 font-medium">Nationwide network</p>
                  </div>
                </CardContent>
              </Card>
            </div>
      ...
      <section className="py-20 bg-gradient-to-br from-gray-50 to-blue-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
              Featured <span className="text-[#329cf9]">Dallas Properties</span>
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                  ...
                  <CardContent className="p-6">
                    ...
                    <div className="flex items-center justify-between mb-4">
                      ...
                      <div className="flex items-center text-gray-600">
                        ...
                        <span className="font-medium">{property.size} AC</span>
                      </div>
                    </div>

                    <Button 
                      className="w-full bg-gradient-to-r from-[#329cf9] to-[#1e40af] hover:from-[#2563eb] hover:to-[#1d4ed8] text-white font-medium transition-all duration-300"
                      onClick={(e) => handlePropertyClick(property as any, e)}
                    >
                      View Details
                    </Button>
                  </CardContent>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
              Dallas Land Investment <span className="text-[#329cf9]">Insights</span>
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Key factors driving the Dallas land market and investment opportunities
            </p>
          </div>
      ...
      <section className="py-20 bg-gradient-to-br from-gray-50 to-blue-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">Common questions about buying land in Dallas</p>
          </div>
