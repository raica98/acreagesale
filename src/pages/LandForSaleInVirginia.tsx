...
export function LandForSaleInVirginia() {
  ...
  const features = [
    { icon: Flag, title: "Government and defense sector", description: "Stable federal employment base" },
    { icon: Factory, title: "Technology and innovation", description: "Growing tech corridor" },
    { icon: Anchor, title: "Port and shipping access", description: "Major East Coast logistics hub" },
    { icon: Sun, title: "Moderate climate", description: "Four seasons with mild winters" },
    { icon: GraduationCap, title: "Quality educational institutions", description: "Universities and research centers" },
    { icon: Target, title: "Strategic East Coast location", description: "Access to major metropolitan areas" }
  ];

  const utilities = [
    { icon: Zap, title: "Electricity", provider: "Dominion Energy/Appalachian Power", cost: "$5,000-$25,000" },
    { icon: Droplets, title: "Water", provider: "Municipal/Private Wells", cost: "$8,000-$15,000" },
    { icon: Wifi, title: "Internet", provider: "Verizon/Comcast/Cox", cost: "$500-$2,500" },
  ...
  const submarkets = [
    {
      ...
      description: "The Washington D.C. metropolitan area represents Virginia's most valuable land market, driven by federal government employment and technology sector growth.",
      priceRange: "$150,000-$500,000+ per acre",
      features: ["Government contracting opportunities", "Technology company presence", "High-density development potential"]
    },
    {
      title: "Central Virginia (Richmond Metro)", 
      description: "Richmond metropolitan area and surrounding counties offer balanced growth with diverse economic drivers and moderate land costs.",
      priceRange: "$25,000-$75,000 per acre",
      features: ["Healthcare and education sectors", "Manufacturing presence", "Mixed-use development opportunities"]
    },
    {
      title: "Hampton Roads (Norfolk-Virginia Beach)",
      description: "Coastal region anchored by Norfolk and Virginia Beach, featuring military installations and port facilities driving land demand.",
      priceRange: "$35,000-$125,000 per acre", 
      features: ["Military installations", "Port and shipping facilities", "Tourism and waterfront development"]
    },
    {
      title: "Rural Virginia (Shenandoah Valley)",
      description: "Agricultural and recreational land opportunities in Shenandoah Valley, Blue Ridge Mountains, and Southside regions.",
      priceRange: "$5,000-$25,000 per acre",
      features: ["Agricultural operations", "Forestry and conservation", "Agritourism development"]
    }
  ];
  ...
  const zoningTypes = [
    { code: "R-1", title: "Single Family Residential", description: "Low-density residential, 1-2 units per acre" },
    { code: "R-2", title: "Low Density Residential", description: "2-4 units per acre, townhomes allowed" },
    { code: "C-1", title: "Neighborhood Commercial", description: "Local retail, offices, services" },
    { code: "A-1", title: "Agricultural", description: "Farming, forestry, agricultural operations" }
  ];

  const faqs = [
    {
      question: "What are property taxes like for land in Virginia?",
      answer: "Virginia property taxes vary by locality, typically ranging from 0.8% to 1.2% of assessed value annually. Agricultural and forestry land may qualify for special use valuation, significantly reducing tax burden. Most counties reassess properties every 4-6 years, though some reassess annually."
    },
    {
      question: "How long does the development approval process take in Virginia?",
      answer: "Development timelines vary by locality and project complexity. Simple residential subdivisions may take 6-12 months, while complex commercial or mixed-use projects can require 12-24 months. Northern Virginia typically has longer timelines due to higher development pressure and more stringent requirements."
    },
    {
      question: "What utilities are typically available for land development in Virginia?",
      answer: "Urban and suburban areas generally have access to municipal water, sewer, electricity, and natural gas. Rural areas may require private wells and septic systems. Dominion Energy provides electricity to most of the state, while water and sewer services are provided by local municipalities or authorities."
    },
    {
      question: "Are there building restrictions for land in Virginia?",
      answer: "Building restrictions vary by zoning classification and locality. Common restrictions include setback requirements, height limitations, density controls, and architectural standards. Coastal areas have additional restrictions under the Chesapeake Bay Preservation Act. Always verify specific restrictions with local planning departments."
    },
    {
      question: "What makes Virginia land a good investment?",
      answer: "Virginia offers political stability, diverse economy, strategic East Coast location, and strong population growth. The state's proximity to Washington D.C., major ports, and transportation corridors creates sustained demand for development. Additionally, Virginia's business-friendly environment attracts corporate relocations and expansions."
    },
    {
      question: "Can I generate income from undeveloped land in Virginia?",
      answer: "Yes, several options exist including agricultural leases ($50-$200/acre), solar leases ($300-$800/acre), hunting leases ($5-$25/acre), and cell tower leases ($1,000-$3,000/month). Timber harvesting can also provide significant one-time income. Income potential depends on location, size, and land characteristics."
    },
    {
      question: "What environmental factors should I consider for Virginia land?",
      answer: "Key considerations include wetlands presence, floodplain designation, soil conditions, and proximity to protected areas. Coastal properties must comply with Chesapeake Bay regulations. Environmental site assessments are recommended for commercial development. Virginia's moderate climate and low natural disaster risk are generally favorable for development."
    },
    {
      question: "How do I finance land purchases in Virginia?",
      answer: "Options include conventional land loans (7.5%-11.5% interest), owner financing (often more flexible terms), hard money loans for quick acquisitions (12%-18% interest), and investment partnerships. Many Virginia banks offer specialized land financing programs. Consider working with lenders familiar with local market conditions."
    }
  ];

  if (success) {
    <SEO slug="land-for-sale-in-virginia" />
    return (
        ...
        <Card className="w-full max-w-2xl mx-4 shadow-2xl border-0 rounded-3xl overflow-hidden">
          <CardContent className="p-12 text-center">
            ...
            <p className="text-xl text-gray-600 mb-8 leading-relaxed">
              We've received your information and will send you the complete list of land for sale in Virginia.
            </p>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold text-gray-900 mb-8 leading-tight">
              Land for Sale in <span className="text-[#329cf9]">Virginia</span>
            </h1>
            <p className="text-xl md:text-2xl text-gray-600 max-w-4xl mx-auto leading-relaxed mb-12">
              Discover prime investment opportunities in one of America's most dynamic markets. From residential development to commercial ventures, Virginia offers exceptional potential.
            </p>
            
            <div className="flex flex-col sm:flex-row gap-6 justify-center mb-16">
              <Link to="/properties?search=Virginia">
      ...
      {/* Why Virginia Section */}
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
              Why Virginia is a <span className="text-[#329cf9]">Prime Investment Market</span>
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-8">
              Population growth and diversified employment continue to drive demand for land across Virginia.
            </p>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
            <div className="text-center p-8 bg-gradient-to-br from-blue-50 to-indigo-50 rounded-2xl border border-blue-200">
              <div className="text-4xl font-bold text-blue-600 mb-2">8.6M</div>
            ...
            <div className="text-center p-8 bg-gradient-to-br from-green-50 to-emerald-50 rounded-2xl border border-green-200">
              <div className="text-4xl font-bold text-green-600 mb-2">$230B</div>
      ...
      <section className="py-20 bg-gradient-to-br from-gray-50 to-blue-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
              Featured Virginia <span className="text-[#329cf9]">Properties</span>
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
              Virginia Regional <span className="text-[#329cf9]">Submarkets</span>
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Understanding the diverse investment opportunities across Virginia's distinct regions
            </p>
          </div>
      ...
      <section className="py-20 bg-gradient-to-br from-gray-50 to-blue-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Essential infrastructure information for land development in Virginia
            </p>
          </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Understanding zoning classifications in Virginia
            </p>
          </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-yellow-700 leading-relaxed">
                  Zoning information is subject to change and should be verified with local Virginia planning departments before making investment decisions. Development requirements, setbacks, and permitted uses may vary by specific location and current regulations. Coastal areas may have additional Chesapeake Bay Act restrictions. Always consult with local planning officials and qualified professionals before proceeding with land development projects.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="py-20 bg-gradient-to-br from-gray-50 to-blue-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
              Want to Buy Land in <span className="text-[#329cf9]">Virginia?</span>
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Fill up the form to get a full list of Land for sale in Virginia.
            </p>
          </div>
                    ...
                    <div className="md:col-span-2">
                      ...
                      <div className="relative">
                        ...
                        <Input
                          ...
                          placeholder="Preferred Location in Virginia"
                          className="pl-12 h-14 border-2 border-gray-200 rounded-xl focus:border-[#329cf9] text-lg"
                        />
                      </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="prose prose-lg max-w-none">
            <h2 className="text-3xl font-bold text-gray-900 mb-8">Land for Sale in Virginia</h2>
            
            <p className="text-gray-700 leading-relaxed mb-6">
              Looking to buy land for sale in Virginia? There are plenty of options out there, ranging from homesites with utilities to raw acreage and everything in between. Before you jump on the first piece of land for sale that you see, however, it pays to do your homework first.
            </p>
            ...
            <h3 className="text-2xl font-bold text-gray-900 mb-6">How to Find the Best Land for Sale in Virginia</h3>
            ...
            <h3 className="text-2xl font-bold text-gray-900 mb-6">Tips to Find Cheap Land for Sale in Virginia</h3>
            ...
            <p className="text-gray-700 leading-relaxed mb-6">
              Buying a foreclosed property can be a great way to get a cheap piece of land for sale in Virginia. A lot of times, the owners of these properties get behind on their mortgage payments and the bank ends up taking possession of the home and selling it at auction.
            </p>
      ...
      <section className="py-20 bg-gradient-to-br from-gray-50 to-blue-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">Common questions about Virginia land investment</p>
          </div>
      ...
      <section className="py-20 bg-[#329cf9]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-4xl md:text-5xl font-bold mb-8 text-white">
            Ready to Invest in Virginia Land?
          </h2>
