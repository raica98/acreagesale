  ...
  const faqs = [
    {
      ...
      answer: "Our quick listing form is completely free. Our AI Auto-Listing service is $200/month and includes professional satellite imagery, AI-generated content, and buyer matching."
    },
    {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold text-gray-900 mb-8 leading-tight">
              Create a New <span className="text-[#329cf9]">Listing</span>
            </h1>
