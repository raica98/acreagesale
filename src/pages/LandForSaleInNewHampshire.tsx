...
import { z } from 'zod';
import { ArrowLeft, Phone, Mail, User, MapPin, Send, Star, CircleCheck as CheckCircle, Building, Globe, Users, TrendingUp, Award, Shield, Zap, Eye, FileText, TreePine, Mountain, Waves, Chrome as Home, DollarSign, Clock, ChartBar as BarChart3, Calculator, Target, Briefcase, GraduationCap, Heart, ShoppingBag, Utensils, Car, Plane, Chrome, CreditCard, Banknote, Handshake } from 'lucide-react';
...
export function LandForSaleInNewHampshire() {
  ...
  const stats = [
    { icon: Users, label: "Active Listings", value: "2,500+", color: "text-blue-600" },
  ...
  const marketStats = [
    { label: "State Population", value: "1.4M", color: "text-blue-600" },
    { label: "Annual GDP", value: "$85B", color: "text-green-600" }
  ];
  ...
  const testimonials = [
    {
      name: "Sarah Johnson",
      role: "Land Investor",
      content: "Found the perfect 10-acre plot in New Hampshire through Acreage Sale. The process was seamless and saved me thousands in fees.",
      rating: 5
    },
    {
      name: "Mike Rodriguez",
  ...
  const featuredProperties = [
    ...
    },
    {
      ...
      location: "Downtown New Hampshire",
      price: 1200000,
      acres: 2.5,
    ...
    },
    {
      ...
      location: "New Hampshire Suburbs", 
      price: 850000,
      acres: 5.2,
  ...
  const regionalMarkets = [
    {
      title: "Southern New Hampshire",
      description: "The most developed region with proximity to Massachusetts employment centers. Higher land values but strong appreciation potential.",
      priceRange: "$25,000 - $45,000",
      keyCities: "Manchester, Nashua, Derry",
      bestFor: "Residential, Commercial",
      icon: Building
    },
    {
      title: "Central New Hampshire", 
      description: "Balanced market with the state capital and lakes region. Mix of development and recreational opportunities.",
      priceRange: "$15,000 - $30,000",
      keyCities: "Concord, Laconia, Franklin",
      bestFor: "Mixed-Use, Recreation",
      icon: Home
    },
    {
      title: "Northern New Hampshire",
      description: "Rural and mountainous region with lower land costs. Ideal for recreational properties and timber investments.",
      priceRange: "$8,000 - $20,000", 
      keyCities: "Berlin, Littleton, Lancaster",
      bestFor: "Recreation, Timber, Hunting",
      icon: Mountain
    },
    {
      title: "Seacoast New Hampshire",
      description: "Premium coastal region with limited land availability. Highest values but strong long-term appreciation.",
      priceRange: "$35,000 - $75,000",
      keyCities: "Portsmouth, Dover, Hampton", 
      bestFor: "Luxury Residential",
      icon: Waves
    }
  ];
  ...
  const zoningTypes = [
    {
      ...
      icon: Home,
      types: [
        "Rural Residential: Large lots, minimal restrictions",
        "Suburban Residential: Standard subdivision development", 
        "Village Residential: Higher density, walkable communities",
    ...
    },
    {
      ...
      icon: Building,
      types: [
        "Village Commercial: Small-scale retail and services",
        "Highway Commercial: Auto-oriented businesses",
        "General Commercial: Mixed retail and office uses", 
        "Tourist Commercial: Hospitality and recreation"
      ]
    },
    {
      category: "Industrial & Special Use",
      icon: Briefcase,
      types: [
        "Light Industrial: Manufacturing and warehousing",
        "Forestry: Timber management and harvesting",
        "Agricultural: Farming and agricultural operations",
        "Conservation: Protected and preserved lands"
      ]
    }
  ];
  ...
  const developmentPhases = [
    ...
    },
    {
      ...
      duration: "3-6 months", 
      tasks: [
        "Submit development applications to planning board",
  ...
  const utilities = [
    {
      ...
      icon: Zap,
      providers: [
        "Eversource Energy: Primary provider",
        "NH Electric Coop: Rural areas", 
        "Liberty Utilities: Select regions",
        "Municipal Systems: Some towns"
      ]
    },
    {
      ...
      icon: Eye,
      providers: [
        "Municipal Systems: Cities and towns",
        "Private Wells: Rural properties",
        "Septic Systems: On-site treatment",
        "Water Districts: Regional providers"
      ]
    },
    {
      ...
      icon: Globe,
      providers: [
        "Comcast Xfinity: Major provider",
        "Consolidated Comm: Rural broadband",
        "TDS Telecom: Regional service",
        "Fiber Networks: Expanding coverage"
      ]
    },
    {
      ...
      icon: Zap,
      providers: [
        "Liberty Utilities: Southern regions",
        "Northern Utilities: Seacoast area",
        "Propane: Rural alternatives", 
        "Oil Heat: Traditional heating"
      ]
    }
  ];
  ...
  const highways = [
    {
      name: "Interstate 95",
      code: "I-95",
      description: "Primary north-south corridor, connects to Boston"
    },
    {
      name: "Interstate 93", 
      code: "I-93",
      description: "Manchester to Vermont, major commercial corridor"
    },
    {
      name: "US Route 3",
      code: "US-3", 
      description: "Scenic route through lakes region"
    },
    {
      name: "Route 16",
      code: "RT-16",
      description: "Eastern corridor to Maine and mountains"
    }
  ];
  ...
  const environmentalFactors = [
    {
      ...
      description: "Steep terrain, granite bedrock, scenic views, recreational development"
    },
    {
      title: "Lakes Region",
      description: "Rolling hills, lake access, seasonal tourism, higher land values"
    },
    {
      title: "Seacoast Plain", 
      description: "Flat terrain, sandy soils, coastal access, premium development"
    },
    {
      title: "Connecticut River Valley",
      description: "Fertile soils, agricultural use, moderate development costs"
    }
  ];
  ...
  const financingOptions = [
    {
      ...
      options: [
        {
          name: "Land Loans",
          description: "Specialized financing for vacant land purchases",
          details: "Rate: 6-8% • Term: 10-20 years • Down: 20-50%"
        },
        {
          name: "Construction Loans", 
          description: "Short-term financing for development projects",
          details: "Rate: Prime + 1-3% • Term: 12-24 months • Down: 25-30%"
        },
        {
          name: "SBA Loans",
          description: "Government-backed financing for commercial development", 
          details: "Rate: 5-7% • Term: 10-25 years • Down: 10-15%"
        }
      ]
    },
    {
      ...
      options: [
        {
          ...
          description: "Direct financing from property sellers",
          details: "Rate: Negotiable • Term: 5-15 years • Down: 10-25%"
        },
        {
          name: "Hard Money Loans",
          description: "Fast funding for time-sensitive opportunities", 
          details: "Rate: 10-15% • Term: 6-24 months • Down: 20-30%"
        },
        {
          name: "Investment Partnerships",
          description: "Joint ventures with other investors",
          details: "Structure: Varies • Returns: 8-15% • Control: Shared"
        }
      ]
    }
  ];
  ...
  const investmentReturns = {
    holdingCosts: [
      ...
      { item: "Insurance", cost: "$200-500/year" },
      { item: "Maintenance", cost: "$100-300/acre" },
      { item: "Legal/Professional", cost: "$500-1,500/year" }
    ],
    incomeOpportunities: [
      { item: "Timber Harvesting", income: "$500-2,000/acre" },
      { item: "Hunting Leases", income: "$5-15/acre/year" },
      { item: "Recreational Leases", income: "$10-25/acre/year" },
      { item: "Solar Leases", income: "$300-800/acre/year" }
    ]
  };

  const faqs = [
    {
      question: "What are property taxes like in New Hampshire?",
      answer: "New Hampshire has no state income tax, but property taxes are higher than the national average. Rates vary by municipality, typically ranging from $15-35 per $1,000 of assessed value. Rural land is often assessed at current use value, which can significantly reduce tax burden."
    },
    {
      question: "How long does development approval take in New Hampshire?",
      answer: "Development approval timelines vary by municipality and project complexity. Simple residential projects may take 3-6 months, while larger commercial or subdivision projects can take 12-18 months. Early consultation with local planning boards is recommended."
    },
    {
      question: "What utilities are available for rural land in New Hampshire?",
      answer: "Rural properties typically rely on private wells for water and septic systems for waste treatment. Electricity is widely available through Eversource or NH Electric Coop. Natural gas availability is limited in rural areas, with propane and oil being common alternatives."
    },
    {
      question: "Are there building restrictions in New Hampshire?",
      answer: "Building restrictions vary by municipality and zoning district. Common restrictions include setback requirements, height limits, and density controls. Shoreland protection acts apply near water bodies. Many towns have adopted building codes based on state standards."
    },
    {
      question: "What makes New Hampshire land a good investment?",
      answer: "New Hampshire offers no state income tax, strong property rights, and proximity to major metropolitan areas. The state's 'Live Free or Die' philosophy creates a business-friendly environment. Limited land supply and growing demand from Massachusetts residents drive appreciation."
    },
    {
      question: "Can I generate income from vacant land in New Hampshire?",
      answer: "Yes, through timber harvesting, hunting leases, recreational vehicle parking, solar installations, and agricultural leases. Forested land can generate $500-2,000 per acre through selective harvesting. Hunting leases typically yield $5-15 per acre annually."
    },
    {
      question: "What environmental factors should I consider in New Hampshire?",
      answer: "Consider wetlands regulations, shoreland protection requirements, and potential endangered species habitats. Soil conditions vary significantly across the state. Winter weather requires proper access planning and utility considerations for year-round use."
    },
    {
      question: "How do I finance land purchases in New Hampshire?",
      answer: "Options include traditional land loans, owner financing, hard money loans, and cash purchases. Local banks familiar with New Hampshire markets often offer competitive rates. Owner financing is common and can provide flexible terms for both buyers and sellers."
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-white">
      <SEO slug="land-for-sale-in-new-hampshire" />
      ...
      <section className="relative py-20 bg-gradient-to-br from-blue-50 via-white to-indigo-50 overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold text-gray-900 mb-8 leading-tight">
            Land for Sale in <span className="text-[#329cf9]">New Hampshire</span>
          </h1>
          
          <p className="text-xl md:text-2xl text-gray-600 max-w-4xl mx-auto leading-relaxed mb-12">
            Discover prime investment opportunities in one of America's most dynamic markets. From residential development to commercial ventures, New Hampshire offers exceptional potential.
          </p>
          
          <div className="flex flex-col sm:flex-row gap-6 justify-center mb-16">
            <Link to="/properties?search=New Hampshire">
      ...
      {/* Why New Hampshire Section */}
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-8">
                Why New Hampshire is a <span className="text-[#329cf9]">Prime Investment Market</span>
              </h2>
              <div className="space-y-6 text-xl text-gray-600 leading-relaxed">
                <p>Population growth and diversified employment continue to drive demand for land across New Hampshire.</p>
            ...
            <div className="relative">
              <img
                ...
                alt="New Hampshire vacant land development opportunities"
                className="w-full h-96 object-cover rounded-3xl shadow-2xl"
              />
              <div className="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent rounded-3xl"></div>
              <div className="absolute bottom-8 left-8 text-white">
                <h3 className="text-2xl font-bold mb-2">New Hampshire</h3>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
              Why Choose <span className="text-[#329cf9]">Acreage Sale</span> for New Hampshire Land?
            </h2>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
              Success Stories from <span className="text-[#329cf9]">New Hampshire Investors</span>
            </h2>
      ...
      <section className="py-20 bg-gradient-to-br from-gray-50 to-blue-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
              Complete <span className="text-[#329cf9]">New Hampshire Land Guide</span>
            </h2>
            <p className="text-xl text-gray-600">Everything you need to know about buying land in New Hampshire</p>
          </div>
              ...
              <CardContent className="p-8 lg:p-12">
                ...
                {success ? (
                  <div className="text-center py-12">
                    ...
                    <p className="text-gray-600">We'll send you the complete land list within 24 hours.</p>
                  </div>
                ) : (
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
              Featured <span className="text-[#329cf9]">New Hampshire Properties</span>
            </h2>
          ...
          <div className="text-center">
            <Link to="/properties?search=New Hampshire">
              <Button className="bg-[#329cf9] hover:bg-[#2563eb] text-white px-8 py-4 text-lg font-semibold rounded-xl">
                View All New Hampshire Properties
              </Button>
            </Link>
          </div>
        </div>
      ...
      <section className="py-20 bg-gradient-to-br from-gray-50 to-blue-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
              New Hampshire <span className="text-[#329cf9]">Regional Submarkets</span>
            </h2>
            <p className="text-xl text-gray-600">Understanding the diverse land markets across the Granite State</p>
          </div>
                ...
                <CardContent className="p-0">
                  ...
                  <div className="space-y-3">
                    <div className="flex justify-between">
                      <span className="font-medium text-gray-700">Avg. Price/Acre:</span>
                      <span className="font-bold text-green-600">{market.priceRange}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="font-medium text-gray-700">Key Cities:</span>
                      <span className="text-gray-900">{market.keyCities}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="font-medium text-gray-700">Best For:</span>
                      <span className="text-[#329cf9] font-medium">{market.bestFor}</span>
                    </div>
                  </div>
                </CardContent>
              </Card>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
              New Hampshire <span className="text-[#329cf9]">Zoning and Development Guide</span>
            </h2>
            <p className="text-xl text-gray-600">Understanding local regulations and development opportunities</p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {zoningTypes.map((zoning, index) => (
              <Card key={index} className="p-8 border-0 shadow-lg hover:shadow-xl transition-all duration-300">
                <CardContent className="p-0">
                  <div className="flex items-center gap-3 mb-6">
                    <div className="w-12 h-12 bg-[#329cf9]/10 rounded-xl flex items-center justify-center">
                      <zoning.icon className="w-6 h-6 text-[#329cf9]" />
                    </div>
                    <h3 className="text-xl font-bold text-gray-900">{zoning.category}</h3>
                  </div>
                  <div className="space-y-3">
                    {zoning.types.map((type, typeIndex) => (
      ...
      <section className="py-20 bg-gradient-to-br from-gray-50 to-blue-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
              New Hampshire <span className="text-[#329cf9]">Development Process Timeline</span>
            </h2>
            <p className="text-xl text-gray-600">Step-by-step guide to developing land in New Hampshire</p>
          </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
              New Hampshire <span className="text-[#329cf9]">Utilities and Infrastructure</span>
            </h2>
            <p className="text-xl text-gray-600">Essential services and infrastructure for land development</p>
          </div>
              ...
              <Card key={index} className="p-6 border-0 shadow-lg hover:shadow-xl transition-all duration-300">
                <CardContent className="p-0">
                  <div className="flex items-center gap-3 mb-6">
                    ...
                    <h3 className="text-lg font-bold text-gray-900">{utility.category}</h3>
                  </div>
                  <div className="space-y-2">
                    {utility.providers.map((provider, providerIndex) => (
                      <div key={providerIndex} className="text-gray-700 text-sm">
                        {provider}
                      </div>
                    ))}
                  </div>
      ...
      <section className="py-20 bg-gradient-to-br from-gray-50 to-blue-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
              New Hampshire <span className="text-[#329cf9]">Transportation Corridors</span>
            </h2>
            <p className="text-xl text-gray-600">Strategic access points and transportation infrastructure</p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
            <div>
              <h3 className="text-2xl font-bold text-gray-900 mb-8">Major Highways</h3>
              <div className="space-y-6">
                {highways.map((highway, index) => (
                  <div key={index} className="flex items-center gap-4 p-6 bg-white rounded-2xl shadow-lg border border-gray-200">
                    <div className="w-16 h-16 bg-[#329cf9] rounded-xl flex items-center justify-center">
                      <span className="text-white font-bold text-sm">{highway.code}</span>
                    </div>
                    <div>
                      <h4 className="font-bold text-gray-900 mb-1">{highway.name}</h4>
            ...
            <div>
              <h3 className="text-2xl font-bold text-gray-900 mb-8">Airports and Rail</h3>
              <div className="space-y-6">
                <div className="flex items-center gap-4 p-6 bg-white rounded-2xl shadow-lg border border-gray-200">
                  ...
                  <div>
                    <h4 className="font-bold text-gray-900 mb-1">Manchester-Boston Regional Airport</h4>
                    <p className="text-gray-600 text-sm">Primary commercial airport, cargo facilities</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-4 p-6 bg-white rounded-2xl shadow-lg border border-gray-200">
                  ...
                  <div>
                    <h4 className="font-bold text-gray-900 mb-1">Pan Am Railways</h4>
                    <p className="text-gray-600 text-sm">Freight rail service throughout state</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-4 p-6 bg-white rounded-2xl shadow-lg border border-gray-200">
                  ...
                  <div>
                    <h4 className="font-bold text-gray-900 mb-1">Concord Coach Lines</h4>
                    <p className="text-gray-600 text-sm">Regional bus service to Boston and beyond</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
              New Hampshire <span className="text-[#329cf9]">Environmental Factors</span>
            </h2>
            <p className="text-xl text-gray-600">Climate, topography, and environmental considerations for land development</p>
          </div>

          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-16">
            <div>
              <h3 className="text-2xl font-bold text-gray-900 mb-8">Climate and Weather</h3>
              <div className="grid grid-cols-2 gap-6">
                <div className="text-center p-6 bg-gradient-to-br from-blue-50 to-indigo-50 rounded-2xl">
                  <div className="text-3xl font-bold text-blue-600 mb-2">45°F</div>
                  <div className="text-gray-600 font-medium">Average Temperature</div>
                </div>
                <div className="text-center p-6 bg-gradient-to-br from-green-50 to-emerald-50 rounded-2xl">
                  <div className="text-3xl font-bold text-green-600 mb-2">43"</div>
                  <div className="text-gray-600 font-medium">Annual Precipitation</div>
                </div>
                <div className="text-center p-6 bg-gradient-to-br from-purple-50 to-violet-50 rounded-2xl">
                  <div className="text-3xl font-bold text-purple-600 mb-2">120-140</div>
                  <div className="text-gray-600 font-medium">Growing Season</div>
                </div>
                <div className="text-center p-6 bg-gradient-to-br from-orange-50 to-amber-50 rounded-2xl">
                  <div className="text-lg font-bold text-orange-600 mb-2">May - Sep</div>
      ...
      <section className="py-20 bg-gradient-to-br from-gray-50 to-blue-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
              New Hampshire <span className="text-[#329cf9]">Land Financing Options</span>
            </h2>
            <p className="text-xl text-gray-600">Funding strategies for land acquisition and development</p>
          </div>
                ...
                <CardContent className="p-0">
                  ...
                  <div className="space-y-6">
                    {category.options.map((option, optionIndex) => (
                      <div key={optionIndex} className="p-6 bg-gradient-to-br from-gray-50 to-blue-50 rounded-2xl border border-gray-200">
                        <h4 className="font-bold text-gray-900 mb-2">{option.name}</h4>
                        <p className="text-gray-600 mb-3">{option.description}</p>
                        <div className="text-sm font-medium text-[#329cf9]">{option.details}</div>
                      </div>
                    ))}
                  </div>
                </CardContent>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
              New Hampshire <span className="text-[#329cf9]">Land Investment Returns</span>
            </h2>
            <p className="text-xl text-gray-600">Understanding costs, returns, and income potential</p>
          </div>

          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <Card className="p-8 border-0 shadow-lg">
              <CardContent className="p-0">
                <h3 className="text-2xl font-bold text-gray-900 mb-8">Annual Holding Costs</h3>
                <div className="space-y-4">
                  {investmentReturns.holdingCosts.map((cost, index) => (
                    <div key={index} className="flex justify-between items-center p-4 bg-gradient-to-br from-red-50 to-orange-50 rounded-xl border border-red-200">
            ...
            <Card className="p-8 border-0 shadow-lg">
              <CardContent className="p-0">
                <h3 className="text-2xl font-bold text-gray-900 mb-8">Income Opportunities</h3>
                <div className="space-y-4">
                  {investmentReturns.incomeOpportunities.map((income, index) => (
                    <div key={index} className="flex justify-between items-center p-4 bg-gradient-to-br from-green-50 to-emerald-50 rounded-xl border border-green-200">
                      <span className="font-medium text-gray-900">{income.item}:</span>
      ...
      <section className="py-20 bg-gradient-to-br from-gray-50 to-blue-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="prose prose-lg max-w-none">
            <h2 className="text-4xl font-bold text-gray-900 mb-8">Land for Sale in New Hampshire</h2>
            
            <p className="text-xl text-gray-600 leading-relaxed mb-8">
              Looking to buy land for sale in New Hampshire? There are plenty of options out there, ranging from homesites with utilities to raw acreage and everything in between. Before you jump on the first piece of land for sale that you see, however, it pays to do your homework first.
            </p>
            ...
            <h3 className="text-3xl font-bold text-gray-900 mb-6">How to Find the Best Land for Sale in New Hampshire</h3>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
              Frequently Asked <span className="text-[#329cf9]">Questions About New Hampshire Land</span>
            </h2>
            <p className="text-xl text-gray-600">Expert answers to common questions about land investment in New Hampshire</p>
          </div>
      ...
      <section className="py-20 bg-gradient-to-br from-gray-50 to-blue-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
              New Hampshire <span className="text-[#329cf9]">Land Investment Insights</span>
            </h2>
            <p className="text-xl text-gray-600">Key factors driving the New Hampshire land market and investment opportunities</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Card className="p-8 border-0 shadow-lg hover:shadow-xl transition-all duration-300">
              <CardContent className="p-0">
                ...
                <p className="text-gray-600 leading-relaxed">New Hampshire continues to attract new residents, driving demand for both residential and commercial land development opportunities.</p>
              </CardContent>
            </Card>
            ...
            <Card className="p-8 border-0 shadow-lg hover:shadow-xl transition-all duration-300">
              <CardContent className="p-0">
                ...
                <p className="text-gray-600 leading-relaxed">Strong economy across technology, manufacturing, tourism, and agriculture creates stable demand for various types of land development projects.</p>
              </CardContent>
            </Card>
            ...
            <Card className="p-8 border-0 shadow-lg hover:shadow-xl transition-all duration-300">
              <CardContent className="p-0">
                ...
                <p className="text-gray-600 leading-relaxed">Proximity to Boston and excellent transportation infrastructure makes New Hampshire land attractive for logistics, distribution, and manufacturing developments.</p>
              </CardContent>
            </Card>
          </div>
        </div>
      ...
      <section className="py-20 bg-[#329cf9]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-4xl md:text-5xl font-bold mb-8 text-white">
            Ready to Invest in New Hampshire Land?
          </h2>
