...
function slugToCity(slug: string): string {
  if (!slug) return "North Carolina";

  const specialCases: { [key: string]: string } = {
    "sell-land-fast-in-north-carolina": "North Carolina",
    "north-carolina": "North Carolina",
    "mn": "North Carolina",
    "minneapolis": "North Carolina City",
    "saint-paul": "Raleigh",
    "duluth": "Durham",
...
export function SellLandFastNorthCarolina() {
  ...
  return (
    <div className="min-h-screen bg-white">
      <SEO slug="sell-land-fast-north-carolina" />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-4xl mx-auto">
            <Badge className="mb-6 bg-green-100 text-green-800 px-4 py-2 text-sm font-semibold">
              North Carolina Cash Land Buyers
            </Badge>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start gap-4 p-4 bg-gray-50 rounded-lg">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Outer Banks drives consistent growth</p>
                  </div>
                </div>
            ...
            <div>
              <img
                src="https://images.pexels.com/photos/1227515/pexels-photo-1227515.jpeg?auto=compress&cs=tinysrgb&w=800"
                alt={`${CITY_NAME} North Carolina land`}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600">
              The fastest, easiest way to sell North Carolina land
            </p>
          </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="text-4xl font-bold text-gray-900 mb-4">
              Every Type of North Carolina Land
            </h2>
            <p className="text-xl text-gray-600">
              From Great Smoky Mountains to Mountains and Coast
            </p>
          </div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600">Trusted by North Carolina landowners</p>
          </div>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Everything you need to know about selling North Carolina land fast
            </p>
          </div>
          ...
          <div className="space-y-8">
                ...
                <div className="flex items-start gap-4 mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-lg text-gray-700 leading-relaxed">
                      Ready to sell your North Carolina land quickly? Submit your property details through our simple form and receive a competitive cash offer within 24 hours. We specialize in fast, hassle-free land transactions throughout {CITY_NAME} and all of North Carolina.
                    </p>
                  </div>
                </div>
              </CardContent>
            ...
            <Card className="border-2 border-gray-200 shadow-lg">
              <CardContent className="p-8 lg:p-10">
                ...
                <div className="space-y-4 text-gray-700 leading-relaxed">
                  <p className="text-lg">
                    Selling land in {CITY_NAME} doesn't have to be complicated. Acreage Sale has revolutionized the land selling process by combining cutting-edge technology with deep local market expertise. Whether you own piedmont waterfront, Outer Banks development land, mountain wilderness hunting properties, or rich agricultural farmland, we provide a streamlined solution that gets you cash fast.
                  </p>
                  <p className="text-lg">
                    Traditional land sales can take 6-12 months and involve numerous uncertainties. Our innovative approach eliminates the waiting, reduces stress, and puts cash in your pocket quickly. We've successfully purchased over $5 million in North Carolina land from more than 1,000 satisfied sellers who needed a fast, reliable solution.
                  </p>
                </div>
              </CardContent>
            </Card>
                ...
                <div className="space-y-8">
                  ...
                  <div className="flex gap-6">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="space-y-3 text-gray-700 leading-relaxed">
                        <p>
                          Our team of North Carolina land specialists reviews your property details and performs a comprehensive market analysis. We examine recent comparable sales in {CITY_NAME}, assess current demand trends influenced by Outer Banks growth and piedmont appeal, evaluate the property's highest and best use, and factor in all relevant market conditions including waterfront premiums, agricultural productivity, and recreational value.
                        </p>
                        <p>
                ...
                <div className="grid md:grid-cols-2 gap-8">
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start gap-3">
                      <CheckCircle className="w-6 h-6 text-green-600 flex-shrink-0 mt-1" />
                      <div>
                        <h4 className="text-xl font-bold text-gray-900 mb-2">Local North Carolina Expertise</h4>
                        <p className="text-gray-700 leading-relaxed">
                          Our team has deep roots and extensive experience throughout North Carolina's diverse land markets. We understand lake regulations, Outer Banks development, mountain wilderness recreation markets, agricultural zones, and seasonal property considerations. This local expertise allows us to make fair offers and close efficiently.
                        </p>
                      </div>
                    </div>
                  </div>
              ...
              <CardContent className="p-8 lg:p-10">
                ...
                <div className="space-y-6">
                  <div className="p-6 bg-white rounded-lg border-2 border-gray-200">
                    ...
                    <p className="text-gray-700 leading-relaxed">
                      North Carolina's legendary coast and rivers create exceptional waterfront opportunities. We regularly purchase lake shore properties, river frontage, recreational waterfront, fishing lake parcels, and seasonal cabin sites. Current market values range from $15,000 to $100,000+ per acre depending on lake quality, shoreline footage, water clarity, proximity to Outer Banks, and recreational amenities. Premium lakes drive top pricing.
                    </p>
                  </div>
                  ...
                  <div className="p-6 bg-white rounded-lg border-2 border-gray-200">
                    ...
                    <p className="text-gray-700 leading-relaxed">
                      North Carolina ranks among America's top agricultural states. We purchase corn and soybean ground, wheat fields, dairy and livestock farms, organic operations, and specialty crop farms. Values range from $5,000 to $25,000 per acre depending on soil productivity, tile drainage, irrigation, proximity to grain elevators, and conservation program enrollment.
                    </p>
                  </div>
              ...
              <CardContent className="p-8 lg:p-10">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <div className="p-5 bg-gray-50 rounded-lg">
                    ...
                    <p className="text-gray-700 leading-relaxed text-sm">
                      North Carolina property taxes can be substantial, especially on lake property. Many owners sell when taxes become burdensome, particularly combined with maintenance costs and seasonal property management expenses.
                    </p>
                  </div>
                  ...
                  <div className="p-5 bg-gray-50 rounded-lg">
                    ...
                    <p className="text-gray-700 leading-relaxed text-sm">
                      Managing seasonal lake cabins or vacation properties from a distance can be challenging. Long winters, maintenance needs, and security concerns lead many owners to sell their North Carolina recreational properties.
                    </p>
                  </div>
                  ...
                  <div className="p-5 bg-gray-50 rounded-lg">
                    ...
                    <p className="text-gray-700 leading-relaxed text-sm">
                      Managing North Carolina property from another state requires regular travel and local contractors. We help out-of-state owners sell quickly without requiring multiple visits for showings, inspections, or closing.
                    </p>
                  </div>
                </div>
              </CardContent>
                ...
                <div className="space-y-6">
                  <div>
                    ...
                    <p className="text-gray-700 leading-relaxed mb-4">
                      North Carolina's land market remains strong in 2025, with several key trends:
                    </p>
                    <ul className="space-y-2 text-gray-700">
                      <li className="flex items-start gap-2">
                        <TrendingUp className="w-5 h-5 text-green-600 flex-shrink-0 mt-1" />
                        <span>Outer Banks growth drives suburban development and land appreciation</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <TrendingUp className="w-5 h-5 text-green-600 flex-shrink-0 mt-1" />
                  ...
                  <div>
                    ...
                    <p className="text-gray-700 leading-relaxed">
                      Several factors point to continued strength in North Carolina land markets including Outer Banks population growth creating suburban demand, limited lake supply maintaining waterfront premiums, strong agricultural economy supporting farmland values, outdoor recreation culture sustaining hunting property demand, and North Carolina's quality of life attracting residents and businesses.
                    </p>
                  </div>
                </div>
              </CardContent>
              ...
              <CardContent className="p-8 lg:p-10">
                ...
                <div className="space-y-6">
                  ...
                  <div className="pb-6 border-b border-gray-200">
                    ...
                    <p className="text-gray-700 leading-relaxed">
                      Yes, we actively purchase lakefront properties, river frontage, and seasonal cabin sites. North Carolina's lake culture creates unique opportunities, and we have extensive experience with lake regulations, shoreline protection, and waterfront property valuations.
                    </p>
                  </div>

                  <div className="pb-6 border-b border-gray-200">
                    <h4 className="text-lg font-bold text-gray-900 mb-2">Can you buy land in northern North Carolina?</h4>
                    <p className="text-gray-700 leading-relaxed">
                      Absolutely. We regularly purchase property throughout northern North Carolina including remote hunting land, timberland, and off-grid properties. Our team understands mountain wilderness market dynamics, seasonal access challenges, and the unique appeal of North Carolina's wilderness areas.
                    </p>
                  </div>
                  ...
                  <div className="pb-6 border-b border-gray-200">
                    ...
                    <p className="text-gray-700 leading-relaxed">
                      Yes, we purchase all types of agricultural land including row crop farms, dairy operations, livestock farms, and specialty crop properties. We understand North Carolina farm programs, tile drainage systems, soil types, and agricultural market dynamics.
                    </p>
                  </div>
                  ...
                  <div className="pb-6 border-b border-gray-200">
                    ...
                    <p className="text-gray-700 leading-relaxed">
                      We regularly purchase seasonal cabins, vacation properties, and recreational land. Whether your property is winterized or seasonal-only, we can evaluate it and make a fair offer. We understand the unique considerations of North Carolina seasonal properties.
                    </p>
                  </div>

                  <div>
                    <h4 className="text-lg font-bold text-gray-900 mb-2">Can you close during North Carolina winter?</h4>
                    <p className="text-gray-700 leading-relaxed">
                      Yes, we can close year-round including during North Carolina winters. Our due diligence process doesn't require physical property visits in most cases, and title work can proceed regardless of weather conditions. We're experienced with North Carolina's seasonal challenges.
                    </p>
                  </div>
                </div>
              </CardContent>
            ...
            <Card className="border-2 border-blue-200 shadow-lg bg-gradient-to-br from-blue-50 to-white">
              <CardContent className="p-8 lg:p-10">
                ...
                <div className="space-y-4 text-gray-700 leading-relaxed">
                  <p className="text-lg">
                    Acreage Sale is a professional land buying company with deep roots in North Carolina's real estate market. Our team combines decades of experience in land acquisition, North Carolina property law and title work, lake and waterfront regulations, agricultural and hunting properties, and market analysis and valuation. We've built our reputation on fair dealing, fast closings, and exceptional customer service.
                  </p>
                  <p className="text-lg">
                    We're not realtors or brokers - we're direct buyers who purchase land for our own investment portfolio. This means we can move quickly without waiting for third-party approvals or financing. We have the cash and capability to close on properties of virtually any size or type throughout North Carolina.
                  </p>
                  <p className="text-lg font-semibold text-gray-900">
                    Our mission is simple: provide North Carolina landowners with a fast, fair, and hassle-free alternative to traditional land sales.
                  </p>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="border-2 border-green-200 shadow-lg bg-gradient-to-br from-green-50 to-white">
              <CardContent className="p-8 lg:p-10 text-center">
                ...
                <p className="text-lg text-gray-700 leading-relaxed mb-6 max-w-3xl mx-auto">
                  If you're ready to explore a fast, cash sale for your North Carolina land, we're here to help. Getting started takes just a few minutes, and you'll have a cash offer in hand within 24 hours. There's no obligation, no pressure, and no fees - just a straightforward offer based on fair market value.
                </p>
                ...
                <p className="text-gray-600 text-lg">
                  Join the 1,000+ North Carolina landowners who have successfully sold their properties through Acreage Sale. Experience the difference that professional land buyers with local expertise and a customer-first approach can make.
                </p>
              </CardContent>
            </Card>
          </div>
              ...
              <form className="space-y-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    required
                    className="w-full px-4 py-3 border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-gray-900"
                    placeholder="123 Main St, North Carolina"
                  />
                </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-8 text-black">
            Join 1,000+ North Carolina landowners who sold fast with us
          </p>
