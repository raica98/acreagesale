...
function slugToCity(slug: string): string {
  if (!slug) return "Louisiana";

  const specialCases: { [key: string]: string } = {
    "sell-land-fast-in-louisiana": "Louisiana",
    "louisiana": "Louisiana",
    "la": "Louisiana",
...
export function SellLandFastLouisiana() {
  ...
  return (
    <div className="min-h-screen bg-white">
      <SEO slug="sell-land-fast-louisiana" />
            ...
            <div>
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-4 p-4 bg-gray-50 rounded-lg">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-900 mb-1">Rich Natural Resources</h3>
                    <p className="text-gray-600">Oil, gas, and timber drive land values</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4 p-4 bg-gray-50 rounded-lg">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-900 mb-1">Growing Cities</h3>
                    <p className="text-gray-600">New Orleans and Baton Rouge expansion</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4 p-4 bg-gray-50 rounded-lg">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Bayous and coastal properties in demand</p>
                  </div>
                </div>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600">
              The fastest, easiest way to sell Louisiana land
            </p>
          </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="text-4xl font-bold text-gray-900 mb-4">
              Every Type of Louisiana Land
            </h2>
            <p className="text-xl text-gray-600">
              From bayou properties to timberland
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              { icon: Droplets, title: "Waterfront & Bayou", price: "$3K-$20K/acre", color: "blue" },
              { icon: Building, title: "Development Land", price: "$5K-$25K/acre", color: "green" },
              { icon: Wheat, title: "Agricultural Land", price: "$2K-$8K/acre", color: "yellow" },
              { icon: TreePine, title: "Timberland", price: "$1.5K-$5K/acre", color: "emerald" },
              { icon: Mountain, title: "Hunting & Recreation", price: "$1K-$6K/acre", color: "cyan" },
              { icon: Award, title: "Oil & Gas Rights", price: "Varies", color: "purple" }
            ].map((type, index) => (
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600">Trusted by Louisiana landowners</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            <Card className="bg-white border-2 border-gray-200 shadow-lg">
              <CardContent className="p-8">
                ...
                <p className="text-gray-700 text-lg mb-6 leading-relaxed">
                  "Needed to sell my bayou property in {CITY_NAME} quickly. Got a fair cash offer in 24 hours and closed in 16 days. The process was incredibly smooth!"
                </p>
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="font-bold text-gray-900">Michael Boudreaux</div>
            ...
            <Card className="bg-white border-2 border-gray-200 shadow-lg">
              <CardContent className="p-8">
                ...
                <p className="text-gray-700 text-lg mb-6 leading-relaxed">
                  "The team handled everything professionally. No hassles, no fees, and they dealt with all the paperwork. Highly recommend for anyone selling Louisiana land!"
                </p>
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="font-bold text-gray-900">Sarah LeBlanc</div>
              ...
              <form className="space-y-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    required
                    className="w-full px-4 py-3 border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-gray-900"
                    placeholder="123 Main St, Louisiana"
                  />
                </div>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Everything you need to know about selling Louisiana land fast
            </p>
          </div>
          ...
          <div className="space-y-8">
                ...
                <div className="flex items-start gap-4 mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-lg text-gray-700 leading-relaxed">
                      Ready to sell your Louisiana land quickly? Submit your property details through our simple form and receive a competitive cash offer within 24 hours. We specialize in fast, hassle-free land transactions throughout {CITY_NAME} and all of Louisiana.
                    </p>
                  </div>
                </div>
              </CardContent>
            ...
            <Card className="border-2 border-gray-200 shadow-lg">
              <CardContent className="p-8 lg:p-10">
                ...
                <div className="space-y-4 text-gray-700 leading-relaxed">
                  <p className="text-lg">
                    Selling land in {CITY_NAME} doesn't have to be complicated. Acreage Sale has revolutionized the land selling process by combining cutting-edge technology with deep local market expertise. Whether you own waterfront property along Louisiana's bayous, timberland, agricultural parcels, or development land near growing cities, we provide a streamlined solution that gets you cash fast.
                  </p>
                  <p className="text-lg">
                    Traditional land sales can take 6-12 months and involve numerous uncertainties. Our innovative approach eliminates the waiting, reduces stress, and puts cash in your pocket quickly. We've successfully purchased over $5 million in Louisiana land from more than 1,000 satisfied sellers who needed a fast, reliable solution.
                  </p>
                </div>
              </CardContent>
            </Card>
                ...
                <div className="space-y-8">
                  ...
                  <div className="flex gap-6">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="space-y-3 text-gray-700 leading-relaxed">
                        ...
                        <p>
                          Unlike traditional buyers who require extensive property tours and inspections upfront, we can evaluate most properties using modern technology including satellite imagery, GIS data, parish records, and comparable sales analysis. This allows us to move quickly while still making fair, accurate offers.
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-6">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="space-y-3 text-gray-700 leading-relaxed">
                        <p>
                          Our team of Louisiana land specialists reviews your property details and performs a comprehensive market analysis. We examine recent comparable sales in {CITY_NAME}, assess current demand trends, evaluate the property's highest and best use, and factor in all relevant market conditions including flood zones, mineral rights, and timber value.
                        </p>
                        <p>
                  ...
                  <div className="flex gap-6">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="space-y-3 text-gray-700 leading-relaxed">
                        <p>
                          Once you accept our offer, we immediately begin the closing process. We work with experienced title companies throughout Louisiana to ensure a smooth transaction. Our team handles all paperwork, coordinates the title search and clearance, manages any survey requirements, and takes care of all closing logistics including mineral rights verification.
                        </p>
                        <p>
                ...
                <div className="grid md:grid-cols-2 gap-8">
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start gap-3">
                      <CheckCircle className="w-6 h-6 text-green-600 flex-shrink-0 mt-1" />
                      <div>
                        <h4 className="text-xl font-bold text-gray-900 mb-2">Local Louisiana Expertise</h4>
                        <p className="text-gray-700 leading-relaxed">
                          Our team has deep roots and extensive experience throughout Louisiana's diverse land markets. We understand waterfront and bayou properties, New Orleans and Baton Rouge expansion areas, timber and agricultural land values, oil and gas considerations, and Louisiana's unique property laws. This local expertise allows us to make fair offers and close efficiently.
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <div className="space-y-6">
                  <div className="p-6 bg-white rounded-lg border-2 border-gray-200">
                    <h4 className="text-xl font-bold text-gray-900 mb-2 flex items-center gap-3">
                      ...
                      Waterfront & Bayou Properties
                    </h4>
                    <p className="text-gray-700 leading-relaxed">
                      Louisiana's extensive waterways and bayous create unique real estate opportunities. We regularly purchase waterfront properties along the Gulf Coast, Mississippi River frontage, bayou and swamp land, lake and pond properties, and fishing camp locations. Current market values range from $3,000 to $20,000+ per acre depending on water access, flood zone, and development potential.
                    </p>
                  </div>
                  ...
                  <div className="p-6 bg-white rounded-lg border-2 border-gray-200">
                    ...
                    <p className="text-gray-700 leading-relaxed">
                      Growing cities like New Orleans, Baton Rouge, Lafayette, and Shreveport are driving demand for development land. We actively purchase subdivided lots, infill parcels near growing metros, large tracts suitable for subdivision, and land zoned for multi-family development. Values typically range from $5,000 to $25,000+ per acre based on location, utilities, zoning, and flood considerations.
                    </p>
                  </div>
                  ...
                  <div className="p-6 bg-white rounded-lg border-2 border-gray-200">
                    ...
                    <p className="text-gray-700 leading-relaxed">
                      Louisiana's fertile soil supports diverse agricultural operations including sugarcane fields, rice farms, cattle ranches, crawfish ponds, and produce operations. We purchase farm land throughout the state, from small family farms to large commercial operations. Current values range from $2,000 to $8,000 per acre depending on soil quality, drainage, irrigation, and crop history.
                    </p>
                  </div>
                  ...
                  <div className="p-6 bg-white rounded-lg border-2 border-gray-200">
                    ...
                    <p className="text-gray-700 leading-relaxed">
                      Louisiana's timber industry remains a major economic driver. We regularly buy pine plantations with active timber management, mixed hardwood forests, cutover land ready for replanting, and properties with timber harvest potential. These properties typically range from $1,500 to $5,000 per acre depending on tree age, species, accessibility, and market conditions.
                    </p>
                  </div>
                  ...
                  <div className="p-6 bg-white rounded-lg border-2 border-gray-200">
                    ...
                    <p className="text-gray-700 leading-relaxed">
                      Louisiana's abundant wildlife and outdoor culture create strong demand for hunting land. We buy properties used for deer, duck, and wild hog hunting, fishing and water recreation, camping and outdoor activities, and recreational camps and clubs. These properties typically range from $1,000 to $6,000 per acre depending on game population, water access, and improvements.
                    </p>
                  </div>
                  ...
                  <div className="p-6 bg-white rounded-lg border-2 border-gray-200">
                    ...
                    <p className="text-gray-700 leading-relaxed">
                      Louisiana's energy sector creates unique opportunities for landowners. We purchase land with existing mineral rights, properties with oil and gas leases, land near active drilling operations, and surface rights with severed minerals. Values vary significantly based on production history, lease terms, and geological assessments.
                    </p>
                  </div>
                </div>
              </CardContent>
              ...
              <CardContent className="p-8 lg:p-10">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <div className="p-5 bg-gray-50 rounded-lg">
                    ...
                    <p className="text-gray-700 leading-relaxed text-sm">
                      Some properties present challenges that make traditional sales difficult including title defects, access disputes, flood damage, or boundary problems. We have the expertise to work through these complications.
                    </p>
                  </div>

                  <div className="p-5 bg-gray-50 rounded-lg">
                    <h4 className="text-lg font-bold text-gray-900 mb-2">Hurricane Recovery</h4>
                    <p className="text-gray-700 leading-relaxed text-sm">
                      Louisiana landowners sometimes need to sell after storm damage or when they decide not to rebuild. We understand the unique challenges hurricane-prone areas face and can close quickly to help you move forward.
                    </p>
                  </div>
                </div>
              </CardContent>
                ...
                <div className="space-y-6">
                  <div>
                    ...
                    <p className="text-gray-700 leading-relaxed mb-4">
                      Louisiana's land market remains active in 2025, with several key trends:
                    </p>
                    <ul className="space-y-2 text-gray-700">
                      <li className="flex items-start gap-2">
                        <TrendingUp className="w-5 h-5 text-green-600 flex-shrink-0 mt-1" />
                        <span>Energy sector activity drives interest in mineral rights and lease opportunities</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <TrendingUp className="w-5 h-5 text-green-600 flex-shrink-0 mt-1" />
                        <span>Growing cities like New Orleans and Baton Rouge increase development land demand</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <TrendingUp className="w-5 h-5 text-green-600 flex-shrink-0 mt-1" />
                        <span>Timber markets remain strong with sustainable forestry practices</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <TrendingUp className="w-5 h-5 text-green-600 flex-shrink-0 mt-1" />
                        <span>Waterfront and bayou properties command premium pricing</span>
                      </li>
                    </ul>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="text-gray-700 leading-relaxed">
                      Several factors point to continued opportunity in Louisiana land markets including ongoing coastal restoration projects creating new development opportunities, sustained energy sector investment, strong agricultural commodity prices supporting farm values, growing recreational and hunting land demand, and infrastructure improvements opening previously remote areas.
                    </p>
                  </div>
                </div>
              </CardContent>
              ...
              <CardContent className="p-8 lg:p-10">
                ...
                <div className="space-y-6">
                  <div className="pb-6 border-b border-gray-200">
                    ...
                    <p className="text-gray-700 leading-relaxed">
                      Our offers are based on comprehensive analysis including recent comparable sales in your area, current market conditions and demand trends, the property's highest and best use potential, flood zone and environmental considerations, timber and mineral rights value, necessary due diligence and closing costs, and our required profit margin as investors. We strive to make fair offers that reflect true market value while accounting for the speed and certainty we provide.
                    </p>
                  </div>
                  ...
                  <div className="pb-6 border-b border-gray-200">
                    ...
                    <p className="text-gray-700 leading-relaxed">
                      In most cases, we can work with existing surveys or use legal descriptions from parish records. If a new survey is needed, we typically handle the cost and coordination as part of our due diligence process.
                    </p>
                  </div>

                  <div className="pb-6 border-b border-gray-200">
                    <h4 className="text-lg font-bold text-gray-900 mb-2">What about mineral rights and oil/gas leases?</h4>
                    <p className="text-gray-700 leading-relaxed">
                      We have extensive experience with Louisiana's complex mineral rights laws. Whether your property has existing leases, severed minerals, or production royalties, we can evaluate and purchase your surface rights while respecting existing mineral agreements. We'll conduct thorough title research to clarify all rights.
                    </p>
                  </div>

                  <div className="pb-6 border-b border-gray-200">
                    <h4 className="text-lg font-bold text-gray-900 mb-2">What if my property is in a flood zone?</h4>
                    <p className="text-gray-700 leading-relaxed">
                      We regularly purchase property in FEMA flood zones throughout Louisiana. Flood zone status is factored into our valuation, but it doesn't prevent us from making an offer. We understand Louisiana's unique relationship with water and can close on properties regardless of flood designation.
                    </p>
                  </div>
                  ...
                  <div className="pb-6 border-b border-gray-200">
                    ...
                    <p className="text-gray-700 leading-relaxed">
                      Yes, we regularly purchase property from trusts, estates, and successions under Louisiana law. We work with executors, trustees, and attorneys to ensure all legal requirements are met and all beneficiaries are properly represented.
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="text-gray-700 leading-relaxed">
                      Yes, we purchase all types of land including properties zoned for commercial development, industrial sites and warehouses, port and waterway access properties, and special-purpose land. If it's land in Louisiana, we're interested.
                    </p>
                  </div>
                </div>
              </CardContent>
            ...
            <Card className="border-2 border-blue-200 shadow-lg bg-gradient-to-br from-blue-50 to-white">
              <CardContent className="p-8 lg:p-10">
                ...
                <div className="space-y-4 text-gray-700 leading-relaxed">
                  <p className="text-lg">
                    Acreage Sale is a professional land buying company with deep roots in Louisiana's real estate market. Our team combines decades of experience in land acquisition, Louisiana property law and title work, agricultural and timber expertise, oil and gas rights evaluation, and market analysis and valuation. We've built our reputation on fair dealing, fast closings, and exceptional customer service.
                  </p>
                  <p className="text-lg">
                    We're not realtors or brokers - we're direct buyers who purchase land for our own investment portfolio. This means we can move quickly without waiting for third-party approvals or financing. We have the cash and capability to close on properties of virtually any size or type throughout Louisiana.
                  </p>
                  <p className="text-lg font-semibold text-gray-900">
                    Our mission is simple: provide Louisiana landowners with a fast, fair, and hassle-free alternative to traditional land sales.
                  </p>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="border-2 border-green-200 shadow-lg bg-gradient-to-br from-green-50 to-white">
              <CardContent className="p-8 lg:p-10 text-center">
                ...
                <p className="text-lg text-gray-700 leading-relaxed mb-6 max-w-3xl mx-auto">
                  If you're ready to explore a fast, cash sale for your Louisiana land, we're here to help. Getting started takes just a few minutes, and you'll have a cash offer in hand within 24 hours. There's no obligation, no pressure, and no fees - just a straightforward offer based on fair market value.
                </p>
                ...
                <p className="text-gray-600 text-lg">
                  Join the 1,000+ Louisiana landowners who have successfully sold their properties through Acreage Sale. Experience the difference that professional land buyers with local expertise and a customer-first approach can make.
                </p>
              </CardContent>
            </Card>
          </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-8 text-black">
            Join 1,000+ Louisiana landowners who sold fast with us
          </p>
